...
namespace MarbleMaker.Core.ECS
{
    ...
    public partial struct LiftStepSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Process faults
            var processFaultsJob = new LiftProcessFaultsJob
            {
                faults = faultQueue
            };
    ...
    /// </summary>
    [BurstCompile]
    public partial struct ProcessLiftsJob : IJobEntity
    {
    ...
    /// </summary>
    [BurstCompile]
    public struct LiftProcessFaultsJob : IJob
    {
    ...
    public partial struct LiftLoadingSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Get ECB for marble loading - Updated for Unity ECS 1.3.14
            var ecbSingleton = GetSingleton<EndFixedStepSimulationEntityCommandBufferSystem.Singleton>();
            var ecb = ecbSingleton.CreateCommandBuffer(state.WorldUnmanaged).AsParallelWriter();
    ...
    /// </summary>
    [BurstCompile]
    public partial struct ProcessLoadingJob : IJobEntity
    {
