...
namespace MarbleMaker.Core.ECS
{
    ...
    public partial struct GoalPadSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Get ECB for marble destruction - Updated for Unity ECS 1.3.14
            ...
            try
            {
                ...
                // Process faults
                var processFaultsJob = new GoalProcessFaultsJob
                {
                    faults = faultQueue
                };
                ...
                handles[0] = faultHandle;
                handles[1] = goalCollectionQueue.Dispose(faultHandle);
                handles[2] = coinAwardQueue.Dispose(faultHandle);
                handles[3] = faultQueue.Dispose(faultHandle);
    ...
    /// </summary>
    [BurstCompile]
    public partial struct ProcessGoalPadsJob : IJobEntity
    {
        ...
        public void Execute(Entity entity, RefRW<GoalPad> goalPad, in CellIndex cellIndex)
        {
    ...
    /// </summary>
    [BurstCompile]
    public struct GoalProcessFaultsJob : IJob
    {
    ...
    public partial struct GoalDetectionSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Get ECB for goal detection - Updated for Unity ECS 1.3.14
            var ecbSingleton = GetSingleton<EndFixedStepSimulationEntityCommandBufferSystem.Singleton>();
            var ecb = ecbSingleton.CreateCommandBuffer(state.WorldUnmanaged).AsParallelWriter();
    ...
    /// </summary>
    [BurstCompile]
    public partial struct DetectGoalsJob : IJobEntity
    {
