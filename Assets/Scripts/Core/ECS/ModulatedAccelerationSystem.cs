...
namespace MarbleMaker.Core.ECS
{
    ...
    /// </summary>
    [BurstCompile]
    public struct BuildModuleCacheJob : IJobEntity
    {
    ...
    /// </summary>
    [BurstCompile]
    public struct BuildConnectorCacheJob : IJobEntity
    {
    ...
    public struct PopulateCacheJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            {
                accelerationCache.TryAdd(moduleAccel.cellKey, moduleAccel);
            }
            ...
            while (connectorAccelerations.TryDequeue(out var connectorAccel))
            {
                ...
                {
                    accelerationCache.TryAdd(connectorAccel.cellKey, connectorAccel);
                }
            }
