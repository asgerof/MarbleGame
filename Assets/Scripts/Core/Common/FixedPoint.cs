...
namespace MarbleMaker.Core
{
    ...
    public struct FixedPoint : IEquatable<FixedPoint>, IComparable<FixedPoint>
    {
        ...
        // Math functions
        public static FixedPoint Abs(FixedPoint value) => new FixedPoint(System.Math.Abs(value.value));
        public static FixedPoint Min(FixedPoint a, FixedPoint b) => new FixedPoint(System.Math.Min(a.value, b.value));
        public static FixedPoint Max(FixedPoint a, FixedPoint b) => new FixedPoint(System.Math.Max(a.value, b.value));
        public static FixedPoint Clamp(FixedPoint value, FixedPoint min, FixedPoint max) => 
            new FixedPoint(System.Math.Max(min.value, System.Math.Min(max.value, value.value)));
        
        // Trigonometric functions for deterministic physics
        public static FixedPoint Sin(FixedPoint radians) => FromFloat((float)System.Math.Sin(radians.ToFloat()));
        public static FixedPoint Cos(FixedPoint radians) => FromFloat((float)System.Math.Cos(radians.ToFloat()));
        public static FixedPoint Tan(FixedPoint radians) => FromFloat((float)System.Math.Tan(radians.ToFloat()));
